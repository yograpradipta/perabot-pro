...
?>
<h2><b><font color="blue">LAPORAN PEMESANAN MASUK</font></b></h2>
<form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" name="form1" target="_self">
  <table width="550" border="0"  class="table-list">
    <tr>
      <td colspan="3" bgcolor="#CCCCCC"><font color="blue"><b>FILTER DATA </b></font></td>
    </tr>
    <tr>
      <td width="55"><font color="blue"><b>Periode </b></font></td>
      <td width="5"><font color="blue"><b>:</b></font></td>
      <td width="426">
...
<font color="blue">Daftar transaksi periode tanggal pesan </font><b><?php echo $tglAwal; ?></b><font color="blue"> s/d </font><b><?php echo $tglAkhir; ?></b><br /><br />
...
<table width="800" border="0" cellpadding="2" cellspacing="1" class="table-list" >
  <tr>
    ...
    <th width="9%" bgcolor="#CCCCCC"><font color="blue"><b>Tanggal</b></font></th>
     <th width="11%" bgcolor="#CCCCCC"><font color="blue"><b>Kode Plg </b></font></th>
   <th width="32%" bgcolor="#CCCCCC"><font color="blue"><strong>Nama Pelanggan </strong></font></th>
    <th width="13%" align="right" bgcolor="#CCCCCC"><font color="blue">Total Barang </font></th>
    <th width="17%" align="right" bgcolor="#CCCCCC"><font color="blue"><b>Total  Bayar (Rp) </b></font></th>
    <th width="8%" align="right" bgcolor="#CCCCCC"><font color="blue"><strong>Status </strong></font></th>
