...
if(isset($_GET['open'])) {
	switch($_GET['open']){				
		...
		case 'lap_tahun' :	
			if(!file_exists ("cetak_tahun.php")) die ("Sorry Empty Page!"); 
				include "cetak_tahun.php";	break;		
			...
			case 'Laporan-harga-servis' :				
				if(!file_exists ("laporan_harga_servis.php")) die ("Sorry Empty Page!"); 
				include "laporan_harga_servis.php"; break;
			...
			case 'Laporan-Pemesanan-Lunas-Periode-Tahun' :
				if(!file_exists ("laporan_pemesanan_lunas_periode_tahun.php")) die ("Sorry Empty Page!"); 
				include "laporan_pemesanan_lunas_periode_tahun.php"; break;	
				
			case 'Laporan-Penjualan-Tahun' :				
			    if(!file_exists ("laporan_penjualan_tahun.php")) die ("Sorry Empty Page!"); 
